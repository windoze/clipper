export const en = {
  ...
  "clip.delete_blocked": "This clip cannot be deleted.",
  "clip.delete_blocked_favorite": "Remove from favorites first.",
  "clip.delete_blocked_tags": "Remove tags first: {tags}",
  ...
  "search.placeholderWithTags": "Search within filtered tags... (# tags, @ hosts)",
  ...
  "share.expiration.label": "Link expires in:",
  "share.expiration.15min": "15 minutes",
  "share.expiration.1hour": "1 hour",
  "share.expiration.6hours": "6 hours",
  "share.expiration.12hours": "12 hours",
  "share.expiration.24hours": "24 hours",
