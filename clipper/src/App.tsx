            ...
            <header className="app-header-unified" data-tauri-drag-region>
              ...
              <div className="header-right">
                <div className="header-button-group">
                  ...
                  />
                  <button className="header-button-group-item" onClick={openSettings} title={`${t("tooltip.settings")} (⌘,)`} tabIndex={-1}>
                  ...
                  <button className="header-button-group-item" onClick={refetch} title={`${t("tooltip.refresh")} (⌘R)`} tabIndex={-1}>
                    <svg width="13" height="13" viewBox="0 0 16 16" fill="currentColor">
            ...
            <header className="app-header" data-tauri-drag-region>
              ...
              <div className="window-controls">
                ...
                <span
                  ...
                  title={wsConnected ? t("status.wsConnected") : t("status.wsDisconnected")}
                />
                <button className="window-control-button" onClick={openSettings} title={`${t("tooltip.settings")} (Ctrl+,)`} tabIndex={-1}>
                  &#9881;
                </button>
                <button className="window-control-button" onClick={refetch} title={`${t("tooltip.refresh")} (Ctrl+R)`} tabIndex={-1}>
                  ↻
                </button>
                <button
